...
public class Add_Department extends JFrame
{
    ...
    Add_Department()
    {
        ...
        b2 = new JButton("Delete Department");
        b4 = new JButton("Update Department");
        ...
        l3 = new JLabel("Department Description");
    ...
    class MyListner implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent ae)
        {
            ...
            if(ae.getActionCommand().equals("Add Department"))
            {
                JOptionPane.showMessageDialog(null ,"Department Record is added Successfully");
            }

            else if(ae.getActionCommand().equals("Update Department"))
            {
                new Admin_Login_Panel();
            }
            else if(ae.getActionCommand().equals("Delete Department"))
            {
                new Admin_Login_Panel();
            }
            ...
            {
                 JOptionPane.showMessageDialog(null ,"Department Record not added Successfully");
            }
