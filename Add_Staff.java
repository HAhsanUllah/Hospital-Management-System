...
public class Add_Staff extends JFrame
{
    ...
    Add_Staff()
    {
        ...
        b2 = new JButton("Delete Staff");
        b4 = new JButton("Update Staff");
    ...
    class MyListner implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent ae)
        {
            ...
            {
                JOptionPane.showMessageDialog(null ,"Staff Record is added Successfully");
            }

            else if(ae.getActionCommand().equals("Update Staff"))
            {
            ...
            {
                 JOptionPane.showMessageDialog(null ,"Staff Record not added Successfully");
            }
